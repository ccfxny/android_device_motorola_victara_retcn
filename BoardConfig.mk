...
TARGET_POWERHAL_SET_INTERACTIVE_EXT := device/motorola/victara_retcn/power/power_ext.c
...
TARGET_LIBINIT_DEFINES_FILE := device/motorola/victara_retcn/init/init_victara.c
